...
function clear_board() {
  images = [
    ...
    "./game_images/bug.png",
    "./game_images/cat.png",
    "./game_images/cerf.png",
    "./game_images/chiken.png",
    "./game_images/cow.png",
    "./game_images/crab.png",
    "./game_images/dauphin.png",
    "./game_images/dog.png",
    "./game_images/donkey.png",
    "./game_images/elephant.png",
    "./game_images/frog.png",
    "./game_images/hedgehog.png",
    "./game_images/horse.png",
    "./game_images/octopus.png",
    "./game_images/pig.png",
    "./game_images/rabbit.png",
    "./game_images/sheep.png",
    "./game_images/turtle.png"
  ];
  current_turn = 1;
  current_cell_pair = [];
  guessed_cells = [];
...
function get_image_per_cell_dictionary() {
  for (var i = 0; i < all_cells.length; i++) {
    image_per_cell_dictionary[all_cells[i].id] =
      eight_random_couples_of_images[i];
  }
}
